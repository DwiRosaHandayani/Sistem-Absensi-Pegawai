                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="input-style-1">
                          ...
                          <input type="username" class="form-control <?= $validation->hasError('username') ? 'is-invalid' : '' ?>" placeholder="Username" name="username" />
                      ...
                      <div class="col-12">
                        <div class="button-group d-flex justify-content-center flex-wrap">
                          <button type="submit" 
                            class="main-btn btn-hover w-100 text-center" 
                            style="background-color: #2E8B57; border-color: #2E8B57; color: white;">
                            Sign In
                          </button>
                        </div>
                      </div>
